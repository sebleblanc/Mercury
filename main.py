...
GPIO.add_event_detect(resetbutton, GPIO.BOTH, callback=reset_event, bouncetime=5000)
...
def thermostat():
    ...
    while run:
      ...
      if stemp >= target_temp+(temp_tolerance/3) and htrstatus !=  htrstate[0] and htrstatus != htrstate[3]:
