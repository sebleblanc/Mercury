...
class BME280:
    ...
    Initialize with:
      - BME280(1) if using a Pi Rev. 2 or later,
      - BME280(0) if using a Pi Rev. 1
    '''

    DEVICE = 0x76

    def __init__(self, bus_type):
        self.bus = smbus.SMBus(bus_type)
    ...
    def readBME280All(self, addr=DEVICE):
        ...
        # Wait in ms (Datasheet Appendix B: Measurement time and
        # current calculation)
        wait_time = (1.25
                     + (2.3 * OVERSAMPLE_TEMP)
        ...
        humidity = ((hum_raw
                     - (dig_H4 * 64.0 + dig_H5 / 16384.0 * humidity))
                    * (dig_H2 / 65536.0
                       * (1.0 + dig_H6 / 67108864.0 * humidity
